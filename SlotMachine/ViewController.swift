...
//  SlotMachine
//
//  Created by David Blanck on 10/26/14.
...
class ViewController: UIViewController {
    ...
    var firstContainer: UIView!  //unwrapping the optional
    ...
    let kMarginForView: CGFloat = 10.0  //like a double to use for frame parameters
    ...
    func betOneButtonPressed (button: UIButton) {
        ...
        if credits <= 0 {
            ...
            if currentBet < 5 {
                ...
                showAlertWithText(message: "You can only bet a max of 5 credits!")
            }
        }
    }
    ...
    func setupFirstContainer(containerView: UIView) {
        self.titleLabel = UILabel()                                         //create label
        self.titleLabel.text = "Super Card Slots"                                //text
        self.titleLabel.textColor = UIColor.yellowColor()                   //color
        self.titleLabel.font = UIFont(name: "MarkerFelt-Wide", size: 40)    //font
        self.titleLabel.sizeToFit()                                         //size height and width label to fit font and text
    ...
    func setupFourthContainer(containerView: UIView) {
        ...
        self.resetButton.titleLabel?.font = UIFont(name: "Superclarendon-Bold", size: 12)   //question mark because it may or may not exist
